...
class UnityApplicationGenerator(object):
    ...
    def __init__(self, state_directory, source_repository=None, destination_directory=None, checkout=None,
                 repo2docker_config=None, use_namespace=None, use_repository=None, use_tag=None, notebook_filename=None):
        ...
        self.notebook = ApplicationNotebook(notebook_filename)

        # Set up docker interface
        self._init_docker_interface(use_namespace, use_repository, use_tag, repo2docker_config)
    ...
    def _init_docker_interface(self, namespace=None, repository=None, tag=None, repo2docker_config=None):
        
        # Use version supplied inside notebook before using commit hash
        if tag is None and 'version' in self.notebook.metadata:
            tag = self.notebook.metadata['version']
    ...
    def create_cwl(self, cwl_output_path=None, docker_url=None, monolithic=False):
        ...
        logger.info("Parameters:\n" + self.notebook.parameter_summary())
            
        # Create CWL files depending on the mode of production
        cwl_generators = [ ProcessCWL(self.notebook, self.repo_info) ]
    ...
    def notebook_parameters(self):
        ...
        params_str += self.notebook.parameter_summary()
    ...
    def notebook_metadata(self):
        ...
        metadata_str += self.notebook.metadata_summary()
